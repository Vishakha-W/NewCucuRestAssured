...
public class MyDataDriven {
	...
	JSONObject object;
	String newJsonStr;
	//Data table is written by cucumber 
	@Given("^user update name with \"([^\"]*)\" name$")
	public void user_update_name_with_name (String username) throws IOException{
		
		//Read data from file
	    data = new String(Files.readAllBytes(Paths.get("F:\\marsproject\\radical\\B17CucuRestAssured\\src\\test\\java\\com\\basic\\dataDrivenSD\\user.json"))); 
